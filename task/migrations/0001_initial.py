# Generated by Django 6.0 on 2026-01-17 04:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('verified', 'Verified/Resolved')], default='pending', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('draft', 'Draft'), ('pending', 'Pending Verification'), ('approved', 'Approved'), ('rejected', 'Rejected')], default='draft', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auth_proof', models.FileField(blank=True, null=True, upload_to='owner_verifications/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('document_file', models.FileField(upload_to='verification/')),
